...
% --- 6. 设置参数文件保存位置 ---
% 设置参数文件的目标保存目录
param_save_path = 'D:\paperwork\Experiment_Data\20Gsyms_30km_12bit\TX_Matlab_Param_mat';
...
vpi_save_path = 'D:\paperwork\Experiment_Data\20Gsyms_30km_12bit\VPI_Input_Data_txt'; 
...
% 3. PCM 模块
quant = 12;                % PCM量化比特数 (8 bit/sample)  通常 3~15bit
